...
public class MainActivity extends Activity {
	...
	public void StartStopButtonPress(View view) {	
		...
		else //means that the timer is stopped so we need to
	 ...
	 if(!file.exists())
	  {
		...
		restClient1.execute("DownloadBundle",
				"http://"+myActivity.serverText.getText()+":8080/com.vogella.jersey.first/rest/hello/downloadbundle",
				myActivity.bundlePath+bName+".apk",bName);	
		}
		else 
